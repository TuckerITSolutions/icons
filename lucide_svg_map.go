...
var lucide_iconSvgData = SVGMap{
	"a-arrow-down": `<svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24" class="svg %s" %s
  stroke-width="2"
...
`,
	"gamepad-directional": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
